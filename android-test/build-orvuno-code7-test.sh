...
android {
    ...
    defaultConfig {
        // Deliberately separate package so this APK can be installed beside the Play version.
        applicationId 'de.nadena.orvuno.test'
        minSdk 23
        targetSdk 36
        versionCode 7
        versionName '1.0.4-test'

        resValue 'string', 'appName', 'ORVUNO Test'
        resValue 'string', 'launcherName', 'ORVUNO Test'
        ...
        resValue 'string', 'providerAuthority', 'de.nadena.orvuno.test.fileprovider'
...
printf 'Generated ORVUNO code7 side-by-side test project at %s\n' "$ROOT"
